...
function Home(){
    ...
    <div className="hero-container" data-aos="fade-in" data-aos-delay="50" data-aos-duration="2000">
      <h1>Hi,</h1>
      <h1>I'm Chaimaa Atraoui</h1>
      <h2 className="inl">
     I'm &nbsp;
     <Typewriter
        options={{
                strings: ['a Student ✨','a Software Developer!✨', 'a Web Developer!✨','a Tech Enthusiast!!✨', ' intersted in Innovative Artificial Intelligence Technologies ☆✨'],
                autoStart: true,
                loop: true,}}
        />
